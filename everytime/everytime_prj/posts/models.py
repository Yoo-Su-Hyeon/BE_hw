...
class Like(models.Model):
    post = models.ForeignKey(to=Post, on_delete=models.CASCADE, related_name="likeposts")
    user = models.ForeignKey(to=User, on_delete=models.CASCADE, related_name="likeusers")

    
class Scrap(models.Model):
    post = models.ForeignKey(to=Post, on_delete=models.CASCADE, related_name="scrapposts")
    user = models.ForeignKey(to=User, on_delete=models.CASCADE, related_name="scrapusers")
